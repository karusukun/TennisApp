 ...
 * @author Carlos
 */
public class DialogDesign extends javax.swing.JFrame {

    /**
     * Creates new form DialogDesign
     */
    public DialogDesign() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(101, 255, 255));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogDesign.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DialogDesign().setVisible(true);
            }
        });
    }
